...
```bash
go get github.com/user0608/bobi/kcheck
```
...
import (
    ...
    "github.com/user0608/bobi/kcheck"
)
...
- punteros
- structs anidados
- structs dentro de slices, arrays, mapas e interfaces

Los ciclos de punteros se detectan y se omiten para evitar recursión infinita.
